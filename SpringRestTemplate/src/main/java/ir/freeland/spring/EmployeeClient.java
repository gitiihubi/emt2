...
public class EmployeeClient {
    ...
    public Employee[] getForEntityEmployeesAsArray() {
        ResponseEntity<Employee[]> response =
                restTemplate.getForEntity("http://127.0.0.1:8080/employees/", Employee[].class);
    ...
    public List<Employee> getAllEmployeesUsingParameterizedTypeReference() {
        ResponseEntity<List<Employee>> response =
                restTemplate.exchange("http://localhost:8080/employees/", HttpMethod.GET, null,
    ...
    public List<Employee> getAllEmployeesUsingWrapperClass() {
        EmployeeList response =
                restTemplate.getForObject("http://127.0.0.1:8080/employees/v2", EmployeeList.class);
    ...
    public void createEmployeesUsingLists() {
        ...
        restTemplate.postForObject("http://localhost:8080/employees/", newEmployees,
    ...
    public void createEmployeesUsingWrapperClass() {
        ...
        restTemplate.postForObject("http://localhost:8080/employees/v2",
                new EmployeeList(newEmployees), ResponseEntity.class);
    }
}
